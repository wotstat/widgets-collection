...
• Добавлен виджет ${Utils.addWidget('https://widgets.wotstat.info/efficiency/stats?accent=da36ffff&solo-align=left&anim=true&slot-1=assist-track&slot-2=assist-radio&slot-3=fire-dmg&slot-4=ammo-bay-destroyed-dmg&slot-5=ram-dmg&slot-6=discover&slot-7=empty&slot-8=empty', 'Расширенная эффективность')}. Сконфигурируйте под себя до 8 параметров из 18 доступных`
  }
]
