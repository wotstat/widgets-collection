...
export default defineWidget({
  ...
  params: [
    ...
    { type: 'select', target: 'slot-3', label: 'Слот 3', variants: slotVariants, default: 'xp-avg' },
    { type: 'select', target: 'slot-4', label: 'Слот 4', variants: slotVariants, default: 'top-sum' },
    { type: 'select', target: 'slot-5', label: 'Слот 5', variants: slotVariants, default: 'battles' },
    { type: 'select', target: 'slot-5', label: 'Слот 5', variants: slotVariants, default: 'battles' },
    { type: 'select', target: 'slot-5', label: 'Слот 5', variants: slotVariants, default: 'battles' },
